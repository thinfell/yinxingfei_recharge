...
EOF;
    ...
    private function buildAlipay()
    {
        ...
        $alipay_config['notify_url'] = $_G['siteurl'].'plugin.php?id=yinxingfei_recharge:notify_url';
        $alipay_config['return_url'] = $_G['siteurl'].'plugin.php?id=yinxingfei_recharge:notify_url';//同步通讯到同一个地址做判断
